...
help:
	@printf '%s\n' \
		...
		'  ICE_GIF_LAYOUT=$(ICE_GIF_LAYOUT)  [map|interface]' \
...
simulator-init:
	...
	SIMULATOR_CONFIG="$(SIMULATOR_CONFIG)" SOFTHIER_POWER_PROFILE="$(SOFTHIER_POWER_PROFILE)" PYTHON="$(PYTHON)" \
